...
#LIBS=	../simplegui/libsimplegui.a ../simplemodel/libsimplemodel.a ../simpletexture/libsimpletexture.a ../simplevideo/libsimplevideo.a ../simpleaudio/libsimpleaudio.a ../simpleconnect/libsimpleconnect.a ../simpleconfig/libsimpleconfig.a `sdl-config --libs` -lSDL_net -lSDL_ttf -lSDL_image -lSDL_mixer -lGL -lGLU
...
#CXX=	g++
#CXXFLAGS=	-g -Wall -DSDL_DEBUG=SDL_INIT_NOPARACHUTE `sdl-config --cflags`
#LIBS=	../simplegui/libsimplegui.a ../simplemodel/libsimplemodel.a ../simpletexture/libsimpletexture.a ../simplevideo/libsimplevideo.a ../simpleaudio/libsimpleaudio.a ../simpleconnect/libsimpleconnect.a ../simpleconfig/libsimpleconfig.a `sdl-config --libs` -lefence -lSDL_net -lSDL_ttf -lSDL_image -lSDL_mixer -lGL -lGLU
