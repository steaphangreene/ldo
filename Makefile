...
#CXX=	g++
#CXXFLAGS=	-s -O2 -Wall `sdl-config --cflags`
#LIBS=	../simplegui/libsimplegui.a ../simplemodel/libsimplemodel.a ../simplevideo/libsimplevideo.a `sdl-config --libs` -lSDL_ttf -lSDL_image -framework OpenGL

#PRODUCTION OPTIONS (WORKAROUND FOR CYGWIN)
#CXX=	g++
#CXXFLAGS=	-s -O2 -Wall `sdl-config --cflags`
#LIBS=	../simplegui/libsimplegui.a ../simplemodel/libsimplemodel.a ../simplevideo/libsimplevideo.a `sdl-config --libs` -lSDL_ttf -lSDL_image -L/usr/X11R6/bin -lopengl32 -lglu32
